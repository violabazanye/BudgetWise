...
namespace BudgetWise
{
    ...
    /// </summary>
    public sealed partial class MyWallet : Page
    {
        ...
        private MobileServiceCollection<Wallets_Table, Wallets_Table> items;
        private IMobileServiceTable<Wallets_Table> walletTable = App.MobileService.GetTable<Wallets_Table>();
       ...
       //     }
        ...
        private async void ReadItems()
        {
            try
            {
                items = await walletTable.ToCollectionAsync();
